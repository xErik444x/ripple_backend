...
export class BirthdayController {
  ...
  @ApiResponse({
    status: 201,
    description: 'Cumpleaños creado exitosamente',
    type: Birthday,
  })
  ...
  @ApiResponse({ status: 401, description: 'No autorizado - API Key inválida' })
  @ApiResponse({ status: 403, description: 'Prohibido - IP no autorizada' })
  findAll(@Query('guildId') guildId: string, @Query('page') page?: number) {
  ...
  @ApiResponse({
    status: 200,
    description: 'Lista de próximos cumpleaños',
    type: [Birthday],
  })
  @ApiResponse({ status: 401, description: 'No autorizado - API Key inválida' })
  @ApiResponse({ status: 403, description: 'Prohibido - IP no autorizada' })
  ...
  @ApiResponse({
    status: 200,
    description: 'Lista de cumpleaños de hoy',
    type: [Birthday],
  })
  @ApiResponse({ status: 401, description: 'No autorizado - API Key inválida' })
  @ApiResponse({ status: 403, description: 'Prohibido - IP no autorizada' })
  ...
  @ApiResponse({
    status: 200,
    description: 'Datos del cumpleaños',
    type: Birthday,
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Cumpleaños actualizado',
    type: Birthday,
  })
  @ApiResponse({ status: 404, description: 'Usuario no encontrado' })
  @ApiResponse({ status: 401, description: 'No autorizado - API Key inválida' })
  ...
  @ApiResponse({
    status: 200,
    description: 'Cumpleaños eliminado',
    type: Birthday,
  })
  @ApiResponse({ status: 404, description: 'Usuario no encontrado' })
  @ApiResponse({ status: 401, description: 'No autorizado - API Key inválida' })
